...
class TestRaceSchedule:
    ...
    def test_race_names(self):
        ...
        assert race_names == ["Australian Grand Prix", "Malaysian Grand Prix", "Bahrain Grand Prix"]
    ...
    def test_race_times(self):
        ...
        assert race_times == ["04:30:00Z", "07:00:00Z", "11:30:00Z"]
    ...
    def test_race_countries(self):
        ...
        assert race_countries == ["Australia", "Malaysia", "Bahrain"]
    ...
    def test_race_localities(self):
        ...
        assert race_localities == ["Melbourne", "Kuala Lumpur", "Sakhir"]
